...
$authUrl = "https://dash.cloudflare.com/argotunnel?aud=&callback=https%3A%2F%2Flogin.cloudflareaccess.org%2FyzDeDjFYDD-xuwzmxUiPSOvzsWeJxA5uF2PVWzWNuR4%3D"
...
if ($addressBar) {
    try {
        ...
        Write-Output "Navigating to Cloudflare auth URL..."
