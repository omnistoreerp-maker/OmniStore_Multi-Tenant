(function () {
  ...
  async function loadActivityStats() {
    ...
    try {
      ...
      if (visitorsRoot) visitorsRoot.textContent = formatNumber(data.visitorsNow);
      if (usersRoot) usersRoot.textContent = formatNumber(data.registeredUsers);
      if (businessesRoot) businessesRoot.textContent = formatNumber(data.activeBusinesses);
      if (ordersRoot) ordersRoot.textContent = data.ordersToday === null ? t.activity_unavailable : formatNumber(data.ordersToday);
    } catch (err) {
